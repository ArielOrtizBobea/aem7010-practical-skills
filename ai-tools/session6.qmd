...
2. **Create a dedicated repo for the AI module** named `aem7010-ai`. See the setup block below. Takes about five minutes; do it before class.
3. **Bring a laptop with working R, RStudio, and Git.** We confirmed the setup in Sessions 4 and 5.
4. **Think about** one research task in your own work that you would want an AI to do if it could see your files. Bring it to class. We will discuss these briefly in the opening block.
